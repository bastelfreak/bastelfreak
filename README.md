...
- [checktheroads/hyperglass](https://github.com/checktheroads/hyperglass) ([v1.0.0-beta.79](https://github.com/checktheroads/hyperglass/releases/tag/v1.0.0-beta.79), 3 days ago) - hyperglass is the network looking glass that tries to make the internet better.
- [voxpupuli/pypuppetdb](https://github.com/voxpupuli/pypuppetdb) ([v2.3.0](https://github.com/voxpupuli/pypuppetdb/releases/tag/v2.3.0), 4 days ago) - Python library for working with the PuppetDB API
