...
- [voxpupuli/puppet-download_file](https://github.com/voxpupuli/puppet-download_file) - Puppet define created that can be used to download files rather than needing to store binaries in puppet repos (1 day ago)
...
- [voxpupuli/puppet-etherpad](https://github.com/voxpupuli/puppet-etherpad) - Puppet Module to install and configure etherpad (1 day ago)
