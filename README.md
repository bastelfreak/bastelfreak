...
- [choria-io/puppet-choria](https://github.com/choria-io/puppet-choria) ([0.24.0](https://github.com/choria-io/puppet-choria/releases/tag/0.24.0), 3 days ago) - Module to install and manage Choria
- [checktheroads/hyperglass](https://github.com/checktheroads/hyperglass) ([v1.0.2](https://github.com/checktheroads/hyperglass/releases/tag/v1.0.2), 3 days ago) - hyperglass is the network looking glass that tries to make the internet better.
