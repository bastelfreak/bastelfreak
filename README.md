...
- [checktheroads/hyperglass](https://github.com/checktheroads/hyperglass) ([v1.0.0-beta.77](https://github.com/checktheroads/hyperglass/releases/tag/v1.0.0-beta.77), 1 day ago) - hyperglass is the network looking glass that tries to make the internet better.
- [choria-io/puppet-choria](https://github.com/choria-io/puppet-choria) ([0.22.1](https://github.com/choria-io/puppet-choria/releases/tag/0.22.1), 1 week ago) - Module to install and manage Choria
- [choria-io/puppet-mcollective](https://github.com/choria-io/puppet-mcollective) ([0.13.1](https://github.com/choria-io/puppet-mcollective/releases/tag/0.13.1), 1 week ago) - A Puppet module to manage MCollective
...
- [do-community/hacktoberfest-repo-topic-apply](https://github.com/do-community/hacktoberfest-repo-topic-apply) ([v0.0.10](https://github.com/do-community/hacktoberfest-repo-topic-apply/releases/tag/v0.0.10), 3 months ago) - Cmd line tool to add a topic to your github repo, defaults to hacktoberfest
...
- [voxpupuli/puppetboard](https://github.com/voxpupuli/puppetboard) ([v2.2.0](https://github.com/voxpupuli/puppetboard/releases/tag/v2.2.0), 6 months ago) - Web frontend for PuppetDB
...
- [voxpupuli/puppet-ferm](https://github.com/voxpupuli/puppet-ferm) ([v5.0.0](https://github.com/voxpupuli/puppet-ferm/releases/tag/v5.0.0), 7 months ago) - Puppet module to manage the ferm firewall tooling
- [voxpupuli/beaker](https://github.com/voxpupuli/beaker) ([4.26.0](https://github.com/voxpupuli/beaker/releases/tag/4.26.0), 7 months ago) - Puppet Acceptance Testing Harness

#### 📜 My recent blog posts


- [Automate let’s encrypt with systemd timer](https://blog.bastelfreak.de/2020/08/automate-lets-encrypt-with-systemd-timer/) (5 months ago)
- [Vox Pupuli Tasks – The solution to manage your git modules!](https://blog.bastelfreak.de/2020/08/vox-pupuli-tasks-the-solution-to-manage-your-git-modules/) (6 months ago)
- [Dovecot: Apply sieve filter to existing emails](https://blog.bastelfreak.de/2020/08/dovecot-apply-sieve-filter-to-existing-emails/) (6 months ago)
- [Arch Linux installation guide](https://blog.bastelfreak.de/2020/06/arch-linux-installation-guide/) (7 months ago)
...
- [voxpupuli/puppet-kafka](https://github.com/voxpupuli/puppet-kafka) - The kafka module for managing the installation and configuration of Apache Kafka (today)
...
- [voxpupuli/puppet-chrony](https://github.com/voxpupuli/puppet-chrony) - Puppet module for Chrony with Systemd (6 days ago)
- [voxpupuli/puppet-jira](https://github.com/voxpupuli/puppet-jira) - Atlassian JIRA Puppet Module (1 week ago)
- [voxpupuli/puppet-nginx](https://github.com/voxpupuli/puppet-nginx) - Puppet Module to manage NGINX on various UNIXes (2 weeks ago)
- [voxpupuli/puppet-archive](https://github.com/voxpupuli/puppet-archive) - Compressed archive file download and extraction with native types/providers for Windows and Unix (2 weeks ago)
- [voxpupuli/hiera-eyaml](https://github.com/voxpupuli/hiera-eyaml) - A backend for Hiera that provides per-value asymmetric encryption of sensitive data (3 weeks ago)
- [voxpupuli/puppet-gitlab](https://github.com/voxpupuli/puppet-gitlab) - Puppet module to manage Gitlab (Omnibus) (3 weeks ago)
- [voxpupuli/puppet-zabbix](https://github.com/voxpupuli/puppet-zabbix) - Puppet module for creating and maintaining zabbix components with puppet. (3 weeks ago)
- [voxpupuli/puppet-keepalived](https://github.com/voxpupuli/puppet-keepalived) - Puppet Module to manage Keepalived (3 weeks ago)
...
- [<img src="https://avatars.githubusercontent.com/u/21196740?u=d978f86ec0903ca44915f5dc36012a29b027bff5&amp;v=4" height="20"/> elserhumano](https://github.com/elserhumano)
- [<img src="https://avatars.githubusercontent.com/u/20618622?u=0e8a54f7a4db298ddfdb5b87714fc9de2146a8ad&amp;v=4" height="20"/> 6at](https://github.com/6at)
