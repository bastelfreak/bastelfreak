...
- [OpenVoxProject/openvox-server](https://github.com/OpenVoxProject/openvox-server) ([8.12.0](https://github.com/OpenVoxProject/openvox-server/releases/tag/8.12.0), 1 day ago) - clone of puppetlabs/puppetserver
- [OpenVoxProject/ezbake](https://github.com/OpenVoxProject/ezbake) ([2.7.2](https://github.com/OpenVoxProject/ezbake/releases/tag/2.7.2), 2 days ago) - clone of puppetlabs/ezbake
- [OpenVoxProject/trapperkeeper-comidi-metrics](https://github.com/OpenVoxProject/trapperkeeper-comidi-metrics) ([1.0.3](https://github.com/OpenVoxProject/trapperkeeper-comidi-metrics/releases/tag/1.0.3), 3 days ago) - clone of puppetlabs/trapperkeeper-comidi-metrics
- [OpenVoxProject/trapperkeeper-metrics](https://github.com/OpenVoxProject/trapperkeeper-metrics) ([2.1.6](https://github.com/OpenVoxProject/trapperkeeper-metrics/releases/tag/2.1.6), 3 days ago) - clone of puppetlabs/trapperkeeper-metrics
- [OpenVoxProject/trapperkeeper-status](https://github.com/OpenVoxProject/trapperkeeper-status) ([1.3.1](https://github.com/OpenVoxProject/trapperkeeper-status/releases/tag/1.3.1), 4 days ago) - clone of puppetlabs/trapperkeeper-status
- [OpenVoxProject/stockpile](https://github.com/OpenVoxProject/stockpile) ([1.0.1](https://github.com/OpenVoxProject/stockpile/releases/tag/1.0.1), 4 days ago) - clone of puppetlabs/stockpile
- [OpenVoxProject/structured-logging](https://github.com/OpenVoxProject/structured-logging) ([1.0.1](https://github.com/OpenVoxProject/structured-logging/releases/tag/1.0.1), 4 days ago) - clone of puppetlabs/structured-logging
- [OpenVoxProject/trapperkeeper-authorization](https://github.com/OpenVoxProject/trapperkeeper-authorization) ([2.1.5](https://github.com/OpenVoxProject/trapperkeeper-authorization/releases/tag/2.1.5), 4 days ago) - clone of puppetlabs/trapperkeeper-authorization
- [OpenVoxProject/clj-rbac-client](https://github.com/OpenVoxProject/clj-rbac-client) ([1.2.3](https://github.com/OpenVoxProject/clj-rbac-client/releases/tag/1.2.3), 4 days ago) - clone of puppetlabs/clj-rbac-client
- [OpenVoxProject/dujour-version-check](https://github.com/OpenVoxProject/dujour-version-check) ([1.1.2](https://github.com/OpenVoxProject/dujour-version-check/releases/tag/1.1.2), 4 days ago) - clone of puppetlabs/dujour-version-check
...
- [OpenVoxProject/trapperkeeper-comidi-metrics](https://github.com/OpenVoxProject/trapperkeeper-comidi-metrics) - clone of puppetlabs/trapperkeeper-comidi-metrics (3 days ago)
...
- [OpenVoxProject/clj-parent](https://github.com/OpenVoxProject/clj-parent) - A clojure project that defines version numbers for common dependencies (5 days ago)
